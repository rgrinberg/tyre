...
(* OASIS_START *)
(* DO NOT EDIT (digest: e6bc5e33debf1e2db17d1f1f6e4e2693) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("example_dim",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$example_dim", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Tyre";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "tyre"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "dims.ml"});
               Test
                 ({
                     cs_name = "example_dim";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("angstrom", None);
                           InternalLibrary "tyre";
                           FindlibPackage ("containers.advanced", None);
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "benchmark_angstrom.ml"
                   })
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\138\150\130\173*\196\031\243Gj\\\169\210,\150\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
